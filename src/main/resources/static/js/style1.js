(function (window, document) {
    var SliderBar = function (targetDom, options) {
        ...
        if (dataList.length > 0) {
            var html = "<div class='slide-box'><div class='slide-img-block'>" +
                ...
                "<div class='scroll-background1 slide-top'></div><div class='slide-img-div'>" +
                ...
                "<div class='scroll-background1  slide-img-hint-info' id='slideHintInfo'>" +
                "<div class='slide-img-hint'><div class='scroll-background1 slide-icon' id='slideIcon'></div>" +
                ...
                "<div class='scroll-background1 slide-bottom'>" +
                "<div class='scroll-background1 slide-bottom-refresh' id='refreshBtn' title='更换图片'></div>" +
                "<div class='slide-bottom-no-logo'></div></div></div></div>" +
                "<div class='scroll-background1 scroll-bar'>" +
                "<div class='scroll-background1 slide-btn' id='slideBtn'></div>" +
    ...
    SliderBar.prototype = {
        ...
        reToNewImg: function () {
            ...
            var imgSrc = "images2/" + _this.imgList[index] + "";
