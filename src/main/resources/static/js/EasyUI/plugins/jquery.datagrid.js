...
(function ($) {
    ...
    function _7(_8) {
        ...
        return {
            add: function (_d) {
                ...
                if (_16) {
                    _16.width = _15;
                    var _17 = this.getRule(_16.index3);
                    if (_17) {
                        _17.style["width"] = _15;
                    }
                }
    ...
    function _169(_16a, _16b) {
        var _16c = _165(_16a, _16b.index3 != undefined ? _16b.index3 : _16b.id);
    ...
    function _186(_187, _188) {
        ...
        view.insertRow.call(view, _187, _188.index3, _188.row);
        _189.push(_188.row);
    ...
    function _18d(_18e, _18f) {
        ...
        var row = opts.finder.getRow(_18e, _18f.index3);
        var _191 = false;
        _18f.row = _18f.row || {};
        ...
        if (_191) {
            ...
            opts.view.updateRow.call(opts.view, _18e, _18f.index3, _18f.row);
        }
    };
    ...
    function _1ab(_1ac, _1ad) {
        ...
        var tr = opts.finder.getTr(_1ac, (_1ad.index3 != undefined ? _1ad.index3 : _1ad.id), _1ad.type);
        if (!tr.length) {
            return;
        }
